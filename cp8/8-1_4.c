...
void do_child(){
    ...
    sigemptyset(&act.sa_mask); // 시그널 처리 중 블록할 시그널 집합 초기화
    sigaddset(&act.sa_mask, SIGINT); // 시그널 처리 중 블록할 시그널 추가
    sigaddset(&act.sa_mask, SIGUSR1); // 시그널 처리 중 블록할 시그널 추가
    sigaddset(&act.sa_mask, SIGUSR2); // 시그널 처리 중 블록할 시그널 추가
